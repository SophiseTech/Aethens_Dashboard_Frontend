...
const permissions = {
  ...
  fdp: {
    mark_don: [ROLES.ADMIN, ROLES.ACADEMIC_MANAGER]
  },
  holidays: {
  ...
  courses: {
    view: [ROLES.ADMIN, ROLES.ACADEMIC_MANAGER, ROLES.FACULTY],
    add: [ROLES.ADMIN, ROLES.ACADEMIC_MANAGER],
    delete: [ROLES.ADMIN, ROLES.ACADEMIC_MANAGER],
    edit: [ROLES.ADMIN, ROLES.ACADEMIC_MANAGER]
  },
  expenses: {
    view: [ROLES.ADMIN, ROLES.OPERATIONS_MANAGER],
    add: [ROLES.ADMIN, ROLES.OPERATIONS_MANAGER],
    edit: [ROLES.ADMIN, ROLES.OPERATIONS_MANAGER],
  },
  ledger: {
