...
class SessionService {
  async getAvailableSessionByDate(date, center_id, sessionDisabledModule) {
    try {
      const response = await post("/sessions/availableSessions", { date, center_id, moduleId: sessionDisabledModule })
