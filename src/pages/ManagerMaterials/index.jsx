...
function ManagerMaterials() {
  ...
  useEffect(() => {
    getMaterials(10, { query: { student_id }, populate: "inventory_item_id student_id", sort: { createdAt: -1 } }, currentPage)
  }, [currentPage])

  return (
    <Title title={"Materials"} button={<AllotMaterialsModal student_id={student_id} />}>
